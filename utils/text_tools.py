...
def load_word2vec_model(model_path, binary_type=True, encoding_type='utf-8', limit_words=None):
    ...
    '''
    word2vec_model = gensim.models.KeyedVectors.load_word2vec_format(model_path, binary=binary_type, limit=limit_words,
                                                                     encoding=encoding_type, unicode_errors='ignore')
